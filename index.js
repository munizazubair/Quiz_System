...
if (q1Input.question1 == "A) A superset of JavaScript") {
    ...
    console.log("Sorrry, that's incorrect. The correct answer is 'A) A superset of JavaScript' ");
}
...
if (q2Input.question2 == "D) All of the above") {
    ...
    console.log("Sorrry, that's incorrect. The correct answer is 'D) All of the above");
}
console.log(`Your Score: ${score}`);
...
let q6Input = await inquirer.prompt([
    {
        name: "question6",
        type: "list",
        message: "Question 6: Which keyword is used to declare a variable in TypeScript?",
...
let q7Input = await inquirer.prompt([
    {
        name: "question7",
        type: "list",
        message: "Question 7: Which TypeScript keyword is used to define a variable with a fixed type that cannot be changed?",
...
let q8Input = await inquirer.prompt([
    {
        name: "question8",
        type: "list",
        message: "Question 8: Which keyword is used to declare a function in TypeScript?",
...
let q9Input = await inquirer.prompt([
    {
        name: "question9",
        type: "list",
        message: "Question 9: Which TypeScript data type is used to represent a single line character?",
...
let q10Input = await inquirer.prompt([
    {
        name: "question10",
        type: "list",
        message: "Question 10: What is the output of the following TypeScript code? \n console.log(10 > 5 && 5 < 3);",
